...
def define_messages(model):
    """
      Location messages
    """      
    message = model.newMessageArray2D("predator_location_message")
    message.newVariableID("id")
#    message.newVariableArrayFloat("pos", 2)
#    message.newVariableFloat("x")
#    message.newVariableFloat("y")
        
    message = model.newMessageArray2D("prey_location_message")
    message.newVariableID("id")
    message.newVariableArrayFloat("pos", 2)
#    message.newVariableFloat("x")
#    message.newVariableFloat("y")
    
    message = model.newMessageArray2D("grass_location_message")
    message.newVariableID("id")
    message.newVariableArrayFloat("pos", 2)
#    message.newVariableFloat("x")
#    message.newVariableFloat("y")
    ...
    message = model.newMessageArray2D("prey_eaten_message")
    message.newVariableID("id")
    message.newVariableInt("pred_id")

    message = model.newMessageArray2D("grass_eaten_message")
    message.newVariableID("id")
...
def initialise_simulation(num_prey, num_predators, num_grass, seed):
    ...
    if not cudaSimulation.SimulationConfig().input_file:
        ...
        for i in range(0, num_prey):
            ...
            prey.setVariableFloat("steer_x", 0.01)
            prey.setVariableFloat("steer_y", 0.01)
        ...
        for i in range(0, num_predators):
            ...
            predator.setVariableFloat("steer_x", 0.01)
            predator.setVariableFloat("steer_y", 0.01)
...
def run_simulation():
    ...
    [cudaSimulation, pop_tracker] = initialise_simulation(num_prey = 200, num_predators = 50, num_grass = 10, seed = 64)
